...
object ExampleDataSource {
    ...
    var jobs : MutableList<Job> = mutableListOf(
        Job(0,2,null, null, "Fulltime","Web Designer","text1","LKR 50000"),
        Job(1,0,null, null, "Fulltime","UI/UX Designer","text1","LKR 50000"),
        Job(2,1,null, null, "Fulltime","Machine learning engineer","text1","LKR 20000"),
        Job(3,3,null, null, "Fulltime","Software engineer","text1","LKR 100000"),
